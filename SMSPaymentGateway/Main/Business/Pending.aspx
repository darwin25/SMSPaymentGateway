<%@ Page Title="" Language="C#" MasterPageFile="~/Main/mainMaster.Master" AutoEventWireup="true" CodeBehind="Pending.aspx.cs" Inherits="SMSPaymentGateway.Main.Business.Pending" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-inline">
                    ...
                    <div class="col-md-12">
                        <asp:Label ID="lblOrderStatus"  runat="server" Font-Bold="True" Font-Size="Larger" Text="PENDING ORDERS" ForeColor="#009933"></asp:Label>
                        <p></p>
                    </div>
                </div>        
                <div class="form-inline">  
                                ...
                                <EmptyDataTemplate>                                    
                                    <div class="form-inline">
                                        ...
                                        <div class="col-md-12" style="text-align: center">
                                            <asp:Label ID="lbEmpty"  runat="server" Text="No Pending Orders" ForeColor="#009933" Width="100%" ></asp:Label>                                        
                                        </div>
                                    </div> 
                                </EmptyDataTemplate>
                            </asp:GridView>    
