<%@ Page Title="" Language="C#" MasterPageFile="~/Main/mainMaster.Master" AutoEventWireup="true" CodeBehind="Received.aspx.cs" Inherits="SMSPaymentGateway.Main.Business.Received" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-inline">
                    ...
                    <div class="col-md-12">
                        <asp:Label ID="lblOrderStatus"  runat="server" Font-Bold="True" Font-Size="Larger" Text="PAYMENTS RECEIVED" ForeColor="#009933"></asp:Label>
                        <p></p>
                    </div>
                </div>        
                <div class="form-inline">  
                    ...
                    <div class="col-md-12">                                                                    
                         <asp:GridView ID="GridView1" runat="server" CssClass="footable"  AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" ShowHeaderWhenEmpty="True" OnRowCommand="GridView1_RowCommand" DataKeyNames="uniquetransactionid" OnRowDataBound="GridView1_RowDataBound">
                                <Columns>
                                ...
                                <EmptyDataTemplate>                                    
                                    <div class="form-inline">
                                        ...
                                        <div class="col-md-12" style="text-align: center">
                                            <asp:Label ID="lbEmpty"  runat="server" Text="No Payments Received" ForeColor="#009933" Width="100%" ></asp:Label>                                        
                                        </div>
                                    </div> 
                                </EmptyDataTemplate>
                            </asp:GridView>    
                         ...
                         <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetOrders" TypeName="Web.Actions.GetOrderAction">
                             <SelectParameters>
                                 ...
                                 <asp:Parameter DefaultValue="Received" Name="orderstatus" Type="String" />
                ...
                <div class="form-inline">
                    <ul class="pager">
                      <li><a href="../Main.aspx"><span class="glyphicon 
                          "></span> Home</a></li>
